 ...
 * del teclado Una vez heredamos, sólo implementamos el keyPressed, y el método
 * típico de "enganche" entre el Control de Teclado y el snakeFrame (controlador
 * del juego)
 * 
 * @author andres
 *
...
public class ControlTeclado implements KeyListener {
	...
	// un montón
	// de información, entre otras cosas el código ASCII de la tecla pulsada, que es
	// lo que nos
